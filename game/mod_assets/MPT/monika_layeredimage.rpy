...
layeredimage monika forward: #All definitions are for her facing forward.
    ...
    group left:
        ...
        attribute ldown default if_any(["dress"]):
            "mod_assets/MPT/monika_casual_dress/1l.png"
        attribute ldown if_any(["black_dress"]):
        ...
        attribute lpoint if_any(["dress"]):
            "mod_assets/MPT/monika_casual_dress/2l.png"
    ...
    group right:
        ...
        attribute rdown default if_any(["dress"]):
            "mod_assets/MPT/monika_casual_dress/1r.png"
        attribute rdown if_any(["black_dress"]):
        ...
        attribute rhip if_any(["dress"]):
            "mod_assets/MPT/monika_casual_dress/2r.png"
    ...
    group blink:
        ...
        attribute blink if_not(["ce","e4a","e4b","e4c","e4d","e4f","e4e","e1e","e1f"]):
            "_mon_blink_a"
...
layeredimage monika lean:
    ...
    group body:
        ...
        attribute body default if_any(["dress"]):
            "mod_assets/MPT/monika_casual_dress/monika_lean_casual_body.png"
    ...
    group head:
        ...
        attribute head default if_any(["dress"]):
            "mod_assets/MPT/monika_casual_dress/monika_lean_casual_facebase.png"
    ...
    group mouth:
        ...
        attribute m4:
            "mod_assets/MPT/monika/monika_lean_mouth_m4.png"
        #CUSTOM ADD from Lecraft pack again
        attribute m5:
            "mod_assets/MPT/monika/monika_lean_mouth_m5.png"
    ...
    group eyes if_not(["n5","bful"]): #Cannot show if full-face blush is present.
        ...
        ##Default Opened eyes:
        attribute oe default if_any(["happ","neut", "vhapp"]):
        ...
        attribute oe default if_any(["angr", "surp"]):
        ...
        #CUSTOM ADD (Monika's new eyes that were in Lecraft images)
        attribute e7:
            "mod_assets/MPT/monika/monika_lean_eyes_e7.png"
    ...
    group blink:
        ...
        attribute blink if_not(["ce","e4","e5","n5", "bful"]):
            "_mon_blink_l_a"
        attribute no_blink default null
