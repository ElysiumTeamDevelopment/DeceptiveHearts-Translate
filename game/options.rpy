...
define config.name = "Deceptive Hearts"
...
define build.name = "DeceptiveHearts"
...
# main menu.
define config.main_menu_music = audio.gh
...
#   Linux: $HOME/.renpy/
define config.save_directory = "DDLC_Deceptive_Hearts"
...
init python:
    ...
    build.package("Deceptive_Hearts", 'zip', 'windows linux mac renpy mod',
