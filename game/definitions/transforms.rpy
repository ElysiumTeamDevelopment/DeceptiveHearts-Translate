...
transform flip_animated:
    subpixel True
    easein .3 yoffset 0 xzoom -1 alpha 1.00

transform no_flip_animated:
    subpixel True
    easein .3 yoffset 0 xzoom 1 alpha 1.00 

transform flip:
    subpixel True xzoom -1
...
transform rhide:
    subpixel True
    on hide:
        easeout .3 xcenter 2000

transform rhide2:
    subpixel True
    on hide:
        alpha 1
        easein .3 xcenter 1100 alpha 0
