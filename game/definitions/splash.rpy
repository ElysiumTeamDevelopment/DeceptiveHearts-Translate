...
init python:
    ...
    splash_messages = [
        ...
        "This game is an unofficial fan game that is\n \
        completely affiliated with Doki Doki Modding Club ;)",
        "Originally Dyinide's idea, then he forced me (iiTzWolfyy) to do it too...\n \
        Nah just kidding."
    ]
...
image menu_art_y:
    subpixel True
    "yuri turned laug e1a blus blink" 
    xcenter 350
    ycenter 450
    zoom 1
...
image menu_art_m:
    subpixel True
    "monika forward flus rhip ma oe blus blink"
    xcenter 1120
    ycenter 450
    zoom 1.00
    menu_art_move(0.9, 1000, 0.6)

image menu_art_headlocker:
    subpixel True
    "headlock turned happ blink"
    xcenter 150
    ycenter 460
    zoom 1.00
    menu_art_move(0.9, 1000, 0.6)
...
image menu_particles:
    ...
    xpos 640
    ypos 134
    ParticleBurst("gui/menu_particle.png", explodeTime=0, numParticles=80, particleTime=2.0, particleXSpeed=3, particleYSpeed=3).sm
    particle_fadeout
...
label splashscreen:
    ...
    if not persistent.first_run:
        ...
        "Also, for fuck's sake, don't take anything in this mod seriously."
    ...
    $ config.main_menu_music = audio.gh
    $ renpy.music.play(config.main_menu_music)
