...
define -2 text_outline_color = "#7eafa0"
        ...
        for i in items:
            ...
            if "kwargs=" in i.caption:
                ...
                if "#" in kwarg:
                    ...
                    textbutton caption:
                        idle_background Frame(im.MatrixColor(im.MatrixColor("mod_assets/choice.png", im.matrix.desaturate() * im.matrix.contrast(1.29) * im.matrix.colorize("#00f", "#fff") * im.matrix.saturation(120)), 
                            im.matrix.desaturate() * im.matrix.colorize(arg1, arg2)), gui.choice_button_borders)
                        hover_background Frame(im.MatrixColor(im.MatrixColor("mod_assets/choice.png", im.matrix.desaturate() * im.matrix.contrast(1.29) * im.matrix.colorize("#00f", "#fff") * im.matrix.saturation(120)), 
...
style choice_button is default:
    ...
    idle_background Frame("mod_assets/save_frame.png", gui.choice_button_borders)
    hover_background Frame("mod_assets/save_frame_hover.png", gui.choice_button_borders)
...
screen about():
    ...
    use game_menu(_("Credits"), scroll="viewport"):
        ...
        window:
            ...
            vbox:
                add Transform("mod_assets/logo.png", size=(380,200)) xalign .5
...
style slot_button:
    ...
    background Frame("mod_assets/save_frame.png", gui.slot_button_borders)
    idle_background Frame("mod_assets/save_frame.png", gui.slot_button_borders)
    hover_background Frame("mod_assets/save_frame_hover.png", gui.slot_button_borders)
